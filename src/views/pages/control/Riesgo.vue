        ...
        <vs-popup title="Riesgo Identificado" :active.sync="popupRiesgo">
            <vx-card class="mb-4" no-shadow card-border>
                ...
                <div class="vx-col w-full mb-4">
                    <label class="text-sm opacity-75">Identificado por</label>
                    <vs-input class="w-full" v-model="inputAuthor" v-validate="''" name="autor" placeholder="Ingrese el nombre de la persona que identificó"/>
                    <span class="text-danger text-sm" v-show="errors.has('autor')">{{ errors.first('autor') }}</span>
                </div>

                <div class="vx-col w-full mb-4">
                    <label class="text-sm opacity-75">Identificado en el Organo/Unidad Orgánica </label>
                    <vs-input class="w-full" v-model="inputOficina" v-validate="''" name="oficina" placeholder="Ingrese el lugar donde se identificó"/>
                    <span class="text-danger text-sm" v-show="errors.has('oficina')">{{ errors.first('oficina') }}</span>
                </div>
    ...
    methods: {
        ...
        editar(tr){
            ...
            .then(response => {
                ...
                if(response.status === 200){
                    ...
                    this.inputAuthor = data.autor;
                    this.inputOficina = data.oficina;
        ...
        guardar(){
            ...
            const paramsData = {
                ...
                autor: this.inputAuthor === null || this.inputAuthor === '' ? '' : this.inputAuthor.trim().toUpperCase(),
                oficina: this.inputOficina === null || this.inputOficina === '' ? '' : this.inputOficina.trim().toUpperCase(),
            }
