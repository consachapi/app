...
export default {
    ...
    data(){
        return {
            ...
            attachments: [],
            dropzoneOptions: {
                url: apiUrl + `/documento/remediacion/upload/`,
    ...
    methods: {
        ...
        addDocumento(){
            ...
            this.upload = this.actividadRemediacionId;

            this.popupSubirArchivo = true;
            this.progress = 0;
            this.dropzoneOptions.url = apiUrl + `/documento/remediacion/upload/` + this.actividadRemediacionId;
        },
